...
sbatch   --job-name=hs-R50   --output=slurm/hs-R50.out   --error=slurm/hs-R50.err   sub_train_and_post_long_queue.sh   configurations/configuration_ResNet50_hsym.yaml
