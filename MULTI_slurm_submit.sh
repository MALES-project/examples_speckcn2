...
sbatch   --job-name=h-R50   --output=slurm/h-R50.out   --error=slurm/h-R50.err   sub_train_and_post_long_queue.sh   configurations/configuration_ResNet50_hard_v2.yaml
sbatch   --job-name=hs-R50   --output=slurm/hs-R50.out   --error=slurm/hs-R50.err   sub_train_and_post_long_queue.sh   configurations/configuration_ResNet50_hsym_v2.yaml
